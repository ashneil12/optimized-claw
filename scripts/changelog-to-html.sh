...
if [[ -z "$version_content" ]]; then
  echo "<h2>Optimized Claw $VERSION</h2>"
  echo "<p>Latest Optimized Claw update.</p>"
  echo "<p><a href=\"https://github.com/ashneil12/optimized-claw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
