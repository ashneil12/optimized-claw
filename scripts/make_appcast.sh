...
FEED_URL=${2:-"https://raw.githubusercontent.com/ashneil12/optimized-claw/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/ashneil12/optimized-claw/releases/download/v${VERSION}/"}
