...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("tavily", "brave", "perplexity", "grok", "gemini", or "kimi"). Auto-detected from available API keys if omitted.',
  ...
  "tools.web.search.tavily.searchDepth":
    'Tavily search depth: "basic" (1 credit), "advanced" (2 credits), or "auto" (Tavily decides). Default: auto.',
  "tools.web.search.tavily.includeAnswer":
    "Include an AI-generated summary answer from Tavily (default: false).",
